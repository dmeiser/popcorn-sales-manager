  ...
  return (
    <Box>
      ...
      <Paper sx={{ p: { xs: 2, sm: 3 }, mb: { xs: 2, sm: 3 } }}>
        ...
        <Stack spacing={2}>
          <Typography variant="body2" color="text.secondary">
            Your data is encrypted at rest and in transit. We collect only the information necessary to provide the
            popcorn sales management service.
          </Typography>
          <Typography variant="body2" color="text.secondary">
      ...
      <Paper sx={{ p: { xs: 2, sm: 3 }, mb: { xs: 2, sm: 3 } }}>
        ...
        <Stack spacing={2}>
          <Typography variant="body2" color="text.secondary">
            KernelWorx is a free, open-source tool built for Scouting America volunteers to manage popcorn sales
            fundraisers.
          </Typography>
          <Typography variant="body2" color="text.secondary">
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            <a href="https://github.com/dmeiser/kernelworx" target="_blank" rel="noopener noreferrer">
              GitHub
            </a>
          </Typography>
        </Stack>
