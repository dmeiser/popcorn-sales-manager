        ...
        <Stack spacing={4}>
            ...
            <Stack spacing={3}>
              <Box>
                ...
                <Typography variant="body1" color="text.secondary">
                  Create seller profiles, track multiple seasons, and manage all your popcorn orders in one place.
                </Typography>
              </Box>
              ...
              <Box>
                ...
                <Typography variant="body1" color="text.secondary">
                  Share seller profiles with parents, den leaders, or unit volunteers. Set read-only or edit permissions.
                </Typography>
              </Box>
              ...
              <Box>
                ...
                <Typography variant="body1" color="text.secondary">
                  Export detailed sales reports in Excel or CSV format. Track totals, payment methods, and delivery status.
                </Typography>
              </Box>
          ...
          >
            ...
            <Typography variant="body2" color="text.secondary">
              You must be at least 13 years old to create an account. If you are under 13, please ask a parent or guardian to create an account and manage your sales.
            </Typography>
          </Paper>
